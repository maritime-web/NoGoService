...
public class WeatherServiceImpl implements WeatherService {
    ...
    public static WeatherException dataOutOfRange(Instant start, Instant end) {
    ...
    @Autowired
    public WeatherServiceImpl(@Value("${rounding.data}") int dataRounding, @Value("${rounding.coordinates}")int coordinateRounding) {
